...
import { Loader2, Sparkles, AlertTriangle, Lightbulb, ThumbsDown, ThumbsUp, CookingPot, Send, Camera, Trash2, FileClock, History } from 'lucide-react';
import { Progress } from "@/components/ui/progress";
import { useAuth } from '@/context/auth-provider';
import { useToast } from '@/hooks/use-toast';
import { db } from '@/lib/firebase';
import { collection, doc, setDoc, query, orderBy, limit, getDocs, onSnapshot } from 'firebase/firestore';
