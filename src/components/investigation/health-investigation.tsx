    ...
    <div className="space-y-8">
      <Card>
        <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <Button onClick={() => view === 'form' ? setView('history') : startNewInvestigation()} className="w-full sm:w-auto">
            {view === 'form' ? <><FileClock className="mr-2"/> View History</> : <><PlusCircle className="mr-2"/> New Investigation</>}
          </Button>
        </CardHeader>
      </Card>
      ...
      {view === 'form' ? (
        ...
        <Card>
            <CardHeader><CardTitle>Investigation History</CardTitle></CardHeader>
            <CardContent>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-bold">
                                                    Investigation from {format(parseISO(c.createdAt), 'MMM d, yyyy')}
                                                </p>
